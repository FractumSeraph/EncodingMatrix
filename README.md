...
- Supported metrics: SSIM, PSNR, and VMAF when the required FFmpeg filter is available.
- You can compute multiple metrics at once via --quality-metrics and keep one primary metric via --quality-metric.
